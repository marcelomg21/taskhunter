    ...
    .then(fbRes => {
        ...
        if (db) {
           var col = db.collection('users');
		    ...
		    //sendmail(facebook_json.email, 'Task Factory', 'Task Factory', "<table border='0' width='600' cellspacing='0' cellpadding='0' align='center'><tbody><tr><td style='padding: 20px 0 10px 0;' align='center' bgcolor='#8c48aa'><img style='display: block;' src='http://nodejs-mongo-persistent-marcelomg21.1d35.starter-us-east-1.openshiftapps.com/images/logo_splash.png' alt='' width='346px' height='64px' /></td></tr><tr><td style='padding: 0px 0 30px 0; font-family: Trebuchet MS, Verdana, Arial, Helvetica, sans-serif; font-size: 18px; color: white;' align='center' bgcolor='#8c48aa'>Bem-vindo " + facebook_json.first_name + "</td></tr><tr><td style='padding: 0px 0px 0px 0px;' bgcolor='#ffffff'><table border='0' width='100%' cellspacing='0' cellpadding='0'><tbody><tr><td valign='top' width='260'><table border='0' width='100%' cellspacing='0' cellpadding='0'><tbody><tr><td><img style='display: block;' src='http://nodejs-mongo-persistent-marcelomg21.1d35.starter-us-east-1.openshiftapps.com/images/email_arrow_go.png' alt='' width='250px' height='188px' /></td></tr><tr><td style='padding: 35px 0 35px 0;'>O Task Factory ajudar&aacute; voc&ecirc; a encontrar profissionais e clientes com prefer&ecirc;ncias em servi&ccedil;os em comum. Para isto, basta ativar sua localiza&ccedil;&atilde;o em seu smartphone, marcar os servi&ccedil;os de sua prefer&ecirc;ncia no menu e pronto! A captura foi iniciada.</td></tr></tbody></table></td><td style='font-size: 0; line-height: 0;' width='20'>&nbsp;</td><td valign='top' width='260'><table border='0' width='100%' cellspacing='0' cellpadding='0'><tbody><tr><td><img style='display: block;' src='http://nodejs-mongo-persistent-marcelomg21.1d35.starter-us-east-1.openshiftapps.com/images/email_crossed.png' alt='' width='250px' height='188px' /></td></tr><tr><td style='padding: 25px 0 0 0;'>Agora basta andar por por a&iacute; e cruzar com outras pessoas no mundo real. Sempre que cruzar com algu&eacute;m, sua Timeline ser&aacute; automaticamente preenchida, com esse usu&aacute;rio, cliente ou profissional. Tudo em tempo real!</td></tr></tbody></table></td></tr></tbody></table></td></tr><tr><td style='padding: 30px 30px 30px 30px;' bgcolor='#8c48aa'><table border='0' cellspacing='0' cellpadding='0'><tbody><tr><td style='color: #ffffff; font-family: Arial, sans-serif; font-size: 14px;'>&copy; 2018 Task Factory.<br /> Acesse<a style='color: #ffffff;' href='www.taskfactory.com.br'><span style='color: #ffffff;'> www.taskfactory.com.br</span></a> para mais informa&ccedil;&otilde;es</td></tr></tbody></table></td></tr></tbody></table>");
